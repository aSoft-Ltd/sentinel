...
public class LibrariesForNpm extends AbstractExternalDependencyFactory {
    ...
    @Inject
    public LibrariesForNpm(DefaultVersionCatalog config, ProviderFactory providers, ObjectFactory objects, ImmutableAttributesFactory attributesFactory, CapabilityNotationParser capabilityNotationParser) {
